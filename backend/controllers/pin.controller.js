  ...
  imagekit
    ...
    .then(async (response) => {
     ...
     const newPin = await Pin.create({
        ...
        description,
        link: link || null,
        board: newBoardId || (board && mongoose.Types.ObjectId.isValid(board) ? board : null),
...
export const interactionCheckPin = async (req, res) => {
  const { id } = req.params;
...
export const interactPin = async (req, res) => {
  const { id } = req.params;
